...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/myhome/pagination/css/pagination.css">
</head>
<body>
                    ...
                    <div class="search_container">
                        ...
                        <div class="search_form_container">
                            <form action="${pageContext.servletContext.contextPath}/basic-search" class="search_form" id="search_form" method="get">
                                ...
                                <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                    <div class="search_inputs d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                        <select class="search_input" style="width: 14%;font-size: 15px;padding: 5px" name="room-min">
                                        ...
                                        <select class="search_input" style="width: 14%;font-size: 15px;padding: 5px" name="room-max">
                                        ...
                                        <select class="search_input" style="width: 14%;font-size: 14px;padding: 3px" name="price-min">
                                        ...
                                        <select class="search_input" style="width: 14%;font-size: 14px;padding: 3px" name="price-max">
                                        ...
                                        <input type="text" class="search_input" name="sq-min" placeholder="Sahə min" style="width: 14%;font-size: 15px;padding: 10px"/>&nbsp;
                                        <input type="text" class="search_input" name="sq-max" placeholder="Sahə max" style="width: 14%;font-size: 15px;padding: 10px"/>&nbsp;
                            ...
                            <div class="listing_content">
                                ...
                                <div class="listing_info">
                                    <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                        ...
                                        <li class="d-flex flex-row align-items-center justify-content-start">
                                            <img src="${pageContext.servletContext.contextPath}/myhome/images/icon_3.png" alt="">
                                            <span>${adv.room}</span>
                                        </li>
