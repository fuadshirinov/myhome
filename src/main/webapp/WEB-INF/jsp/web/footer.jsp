                        ...
                        <div class="footer_info">
                            <ul>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div><img src="${pageContext.servletContext.contextPath}/myhome/images/phone-call.svg" alt=""></div>
                                    <span>+546 990221 123</span>
                                </li>
                                <!-- Address -->
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div><img src="${pageContext.servletContext.contextPath}/myhome/images/placeholder.svg" alt=""></div>
                                    <span>Main Str, no 23, New York</span>
                                </li>
                                <!-- Email -->
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div><img src="${pageContext.servletContext.contextPath}/myhome/images/envelope.svg" alt=""></div>
                ...
                <div class="col-xl-3 col-lg-6 footer_col">
                    ...
                    <div class="listing_small">
                        <div class="listing_small_image">
                            <div>
                                <img src="${pageContext.servletContext.contextPath}/myhome/images/test1.jpg" alt="">
                            </div>
                            <div class="listing_small_tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                                <div class="listing_small_tag tag_house"><a href="${pageContext.servletContext.contextPath}/myhome/listings.html">house</a></div>
                        ...
                        <div class="listing_small_content">
                            ...
                            <div class="listing_small_info">
                                <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                    ...
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        <img src="${pageContext.servletContext.contextPath}/myhome/images/icon_5.png" alt="">
                                        <span>2</span>
                                    </li>
                                </ul>
                            </div>
